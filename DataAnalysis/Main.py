...
def extract_csv_file(_csvfile_path, _output_folder_path):
	column_dic = {"SUBNET_ID": 4, "NETELE_ID": 5, "START_TIME": 1, "END_TIME": 2, "CPU_PEAK_USAGE": 8,
	              "CPU_AVARATE_USAGE": 9, "CPU_OVERLOAD_RATE": 10, "MEMORY_PEAK_USAGE": 11, "MEMORY_AVARATE_USAGE": 12,
	              "MEMORY_OVERLOAD_RATE": 13}
	column_name = ["SUBNET_ID", "NETELE_ID", "START_TIME", "END_TIME", "CPU_PEAK_USAGE", "CPU_AVARATE_USAGE",
	               "CPU_OVERLOAD_RATE", "MEMORY_PEAK_USAGE", "MEMORY_AVARATE_USAGE",
...
def extract_excel_file(_excel_file_path, _output_folder_path):
	...
	column_dic = {"SUBNET_ID": 5, "NETELE_ID": 6, "START_TIME": 2, "END_TIME": 3, "CPU_PEAK_USAGE": 9,
	              "CPU_AVARATE_USAGE": 10, "CPU_OVERLOAD_RATE": 11, "MEMORY_PEAK_USAGE": 12, "MEMORY_AVARATE_USAGE": 13,
